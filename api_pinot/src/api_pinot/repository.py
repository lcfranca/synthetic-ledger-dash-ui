...
class DashboardRepository:
    def __init__(self) -> None:
        ...
        self.realtime_table = self.table if self.table.endswith("_REALTIME") else f"{self.table}_REALTIME"
    ...
    async def get_sales_workspace(
        ...
        *,
        ...
        SELECT
            sale_id,
            LASTWITHTIME(order_id, occurred_at_epoch_ms, 'STRING') AS order_id,
            LASTWITHTIME(occurred_at, occurred_at_epoch_ms, 'STRING') AS occurred_at,
            LASTWITHTIME(customer_id, occurred_at_epoch_ms, 'STRING') AS customer_id,
            LASTWITHTIME(customer_name, occurred_at_epoch_ms, 'STRING') AS customer_name,
            LASTWITHTIME(customer_cpf, occurred_at_epoch_ms, 'STRING') AS customer_cpf,
            LASTWITHTIME(customer_email, occurred_at_epoch_ms, 'STRING') AS customer_email,
            LASTWITHTIME(customer_segment, occurred_at_epoch_ms, 'STRING') AS customer_segment,
            LASTWITHTIME(channel, occurred_at_epoch_ms, 'STRING') AS channel,
            LASTWITHTIME(channel_name, occurred_at_epoch_ms, 'STRING') AS channel_name,
            LASTWITHTIME(payment_method, occurred_at_epoch_ms, 'STRING') AS payment_method,
            MAX(payment_installments) AS payment_installments,
            LASTWITHTIME(order_status, occurred_at_epoch_ms, 'STRING') AS order_status,
            LASTWITHTIME(order_origin, occurred_at_epoch_ms, 'STRING') AS order_origin,
            LASTWITHTIME(coupon_code, occurred_at_epoch_ms, 'STRING') AS coupon_code,
            LASTWITHTIME(device_type, occurred_at_epoch_ms, 'STRING') AS device_type,
            LASTWITHTIME(sales_region, occurred_at_epoch_ms, 'STRING') AS sales_region,
            LASTWITHTIME(freight_service, occurred_at_epoch_ms, 'STRING') AS freight_service,
            LASTWITHTIME(product_name, occurred_at_epoch_ms, 'STRING') AS lead_product,
