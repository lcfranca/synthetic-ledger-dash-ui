...
class ClickHouseAdapter(StorageAdapter):
    ...
    async def _ensure_schema(self) -> None:
        ...
        CREATE TABLE IF NOT EXISTS ledger.entries (
            ...
            freight_service Nullable(String),
            cart_items_count UInt32,
            cart_quantity Float64,
            cart_gross_amount Float64,
            cart_discount Float64,
            cart_net_amount Float64,
            sale_line_index UInt32,
        ...
        alter_statements = [
            ...
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS customer_name Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS customer_cpf Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS customer_email Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS customer_segment Nullable(String)",
            ...
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS sale_id Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS order_id String DEFAULT ''",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS order_status Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS order_origin Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS payment_method Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS payment_installments UInt32 DEFAULT 1",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS coupon_code Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS device_type Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS sales_region Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS freight_service Nullable(String)",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS cart_items_count UInt32 DEFAULT 1",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS cart_quantity Float64 DEFAULT 0",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS cart_gross_amount Float64 DEFAULT 0",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS cart_discount Float64 DEFAULT 0",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS cart_net_amount Float64 DEFAULT 0",
            "ALTER TABLE ledger.entries ADD COLUMN IF NOT EXISTS sale_line_index UInt32 DEFAULT 1",
        ]
